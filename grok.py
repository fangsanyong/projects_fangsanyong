...
test_data_dir='test_images_dense_sparse_matching'
# ==============================
# 配置：选择你要加载的模型路径
# ==============================
...
image_left_path = os.path.join(test_data_dir, "image_left.jpg")
mask_left_path = os.path.join(test_data_dir, "image_left_fg.png")
image_right_path = os.path.join(test_data_dir, "image_right.jpg")
mask_right_path = os.path.join(test_data_dir, "image_right_fg.png")
